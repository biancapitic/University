...
///Complexity: BC = Theta(1), WC = Theta(n), AC = O(n), n=number of keys in the map
...
///Complexity: BC = Theta(1), WC = Theta(n + m), AC = O(n + m), n=number of keys in the map, m=number of values in the SLLA of the key
