...
class UI:
    def __init__(self, service):
        self._commands = {"1": self.__ui_read_from_a_file, "2": self.__ui_create_random_graph,
                          ...
                          "19": self.__ui__minimum_cost_path, "20": self.__ui_highest_cost_path,
                          "21": self.__ui_number_of_paths_in_a_dag}
    ...
    def __ui_highest_cost_path(self):
        vertices_number = self._service.service_get_number_of_vertices()
        if vertices_number == 0:
            print("The graph is empty.")
        else:
            try:
                ...
                path_cost = 0
                reversed_path = []
                path_cost, reversed_path = self._service.service_get_highest_cost_path(source_vertex,
                                                                                       destination_vertex)
                if path_cost is None and reversed_path == []:
                    print("We cannot find a highest cost path between ", source_vertex, " and ", destination_vertex,
                          "because there is a cycle in the graph. The graph is not a DAG.\n")
                elif not reversed_path:
                    print("There is no path from ", source_vertex, " to ", destination_vertex)
                elif len(reversed_path) == 1:
                    print("The highest cost path between ", source_vertex, " and ", destination_vertex, " is 0", ".\n")
                else:
                    print("The cost of the path is: ", path_cost)
                    i = len(reversed_path) - 1
                    print("The path is:")
    ...
    def __ui_number_of_paths_in_a_dag(self):
        vertices_number = self._service.service_get_number_of_vertices()
        if vertices_number == 0:
            print("The graph is empty.")
        else:
            try:
                source_vertex = int(input("Enter source vertex: "))
                destination_vertex = int(input("Enter destination vertex: "))
                number_of_paths = self._service.get_number_of_paths_between_two_vertices_from_a_dag(source_vertex, destination_vertex)
                if number_of_paths is None:
                    print("The graph is not a DAG.\n")
                elif number_of_paths == 0:
                    print("There is no path from vertex ", source_vertex, " to vertex ", destination_vertex, ".\n")
                else:
                    print("The number of distinct paths from vertex ", source_vertex, " to vertex ",
                          destination_vertex, " is: ", number_of_paths, ".\n")
            except GraphExceptions as e:
                print(e)
            except ValueError:
                print("Wrong input!")
    ...
    def print_commands(self):
        print("\n"
              ...
              "20: Get highest cost path between two vertices.\n"
              "21: Get the number of distinct paths between 2 vertices in a DAG.")
